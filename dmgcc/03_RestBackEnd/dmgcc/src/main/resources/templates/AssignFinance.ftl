      ...
      >
        <div style="background: white; border-radius: 10px;     padding: 3%;">
          ...
          <p style="font-size: 15px" class="content2">
            New Project and Business Requirements updated in G3C
          </p>
          ...
          <p style="font-size: 15px">
            Kindly look into the G3C appilication and proceed the further process.
          </p>
          
          <a href="${redirectUrl}" style="font-size: 15px;color:red;"
                 target="_blank">Click here to view in G3C link</a>
          <p
            style="
              font-size: 16px;
