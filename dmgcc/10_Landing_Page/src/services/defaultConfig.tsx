import {   Fonts,
  ...
  RouteTransition,
  ThemeMode,
  ThemeStyle,ThemeStyleRadius } from "../Shared/constants/AppEnums";

export const textLight = {
  primary: "#00677F", //chnage color
...
export const DarkSidebar: SidebarData = {
  ...
  sidebarMenuSelectedTextColor: "#00677F",
  mode: ThemeMode.DARK,
};
export const LightSidebar: SidebarData = {
  sidebarBgColor: "#fff",
  sidebarTextColor: "#00677F", //change values
  sidebarHeaderColor: "#fff",
  sidebarMenuSelectedBgColor: "#00677F",
