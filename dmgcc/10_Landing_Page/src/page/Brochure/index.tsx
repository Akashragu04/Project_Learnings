...
import { reqBrochureData, reqCommonGet, reqCommonGetBrochure } from '../../saga/actions/other.actions';
...
// const [openBrochureDetails, setBrochureDetails] = React.useState(null)
        ...
        <div className="row g-4">
            {
                ...
                props.resBrochureDetails.map((item?:any, index?:any)=>(
                    <CommonPost data={item} key={index} onOpenBrochureDetails={onOpenBrochureDetails} onOpenAlterMessage={onOpenAlterMessage}/>
                ))
                :<Box>No Data</Box>
            }
