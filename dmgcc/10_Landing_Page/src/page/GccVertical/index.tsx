...
import { reqCapabilitiesData, reqCostEngineeringData, reqCostEngineeringSubCntData, 
  reqCustomerServicesData, reqCustomerServicesSubCntData, reqFinanceControllingData, reqFinanceControllingSubCntData, 
  reqHumanResourcesData, reqHumanResourcesSubCntData, reqInformationRechnologyData, reqLeanProcessData, reqLeanProcessSubCntData, 
  reqManufacturingEngineerData, reqManufacturingEngineerSubCntData, reqProductEngineerData, reqProductEngineerSubCntData, 
  reqQualityManagementData, reqQualityManagementSubCntData, reqSupplierManagementData, reqSupplierManagementSubCntData } from '../../saga/actions';
...
const GccVertical = (props:any) => {
    ...
    // console.log(props.resCustomerServicesData, props.resSubContentCustomerServicesData, 'props.resSubContentCustomerServicesData....')
    return (
        <React.Fragment>
            <Header />
