...
const validationUserTypes = () => {
//  start
// This is function use validation on user role based bind menu list
if(CommonStore().userRoleType !== null && CommonStore().userRoleType !== undefined && CommonStore().userRoleType){ // validation user types
  userRoleTypes = CommonStore().userRoleType;
}else {
  userRoleTypes = RoutePermittedRole.unauthorized
}
}
