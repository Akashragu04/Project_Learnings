...
import { capabilitiesDetails, costEngineeringDetails, costEngineeringSubCntDetails, customerServicesDetails, customerServicesSubCntDetails, financeControllingDetails, financeControllingSubCntDetails, humanResourcesDetails, humanResourcesSubCntDetails, informationRechnologyDetails, leanProcessDetails, leanProcessSubCntDetails, manufacturingEngineerDetails, manufacturingEngineerSubCntDetails, productEngineerDetails, productEngineerSubCntDetails, qualityManagementDetails, qualityManagementSubCntDetails, supplierManagementDetails, supplierManagementSubCntDetails } from "../sagas/gccvertical.saga";
