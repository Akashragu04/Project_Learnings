          ...
          <Grid container spacing={3}>
            <Grid item xs={6}>
              <Box sx={{ textAlign: "left" }}>
                <Typography sx={{ flex: 1 }} variant='h5' component='div'>Request Date </Typography>
              </Box>
            </Grid>
            <Grid item xs={6}>
            ...
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'> Service Receiver Contact Name</Typography>
            </Grid>
            <Grid item xs={6}>
              :  {props.getLeadDetails.service_receiver_contact_name}
            </Grid>
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Service Receiver Email ID</Typography>
            </Grid>
            <Grid item xs={6}>
              :  {props.getLeadDetails.service_receiver_email_id}
            </Grid>
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Service Receiver Entity</Typography>
            </Grid>
            <Grid item xs={6}>
              :  {props.getLeadDetails.service_receiver_entity}
            </Grid>
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Project Name</Typography>
            </Grid>
            <Grid item xs={6}>
              :  {props.getLeadDetails.project_name}
            </Grid>
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>Service Provider Short Id</Typography>
            ...
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Service Provider Contact Name</Typography>
            ...
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Service Provider Email ID</Typography>
            </Grid>
            <Grid item xs={6}>
              :  {props.getLeadDetails.service_provider_email_id}
            </Grid>
            <Grid item xs={6}>
              <Typography sx={{ flex: 1 }} variant='h5' component='div'>  Service Provider Department</Typography>
            </Grid>
            <Grid item xs={6}>
                ...
                props.getLeadDetails.supporting_files.map((items: any, index: any) => (
                  <Grid item xs={3}  key={index}>
                    <Link to={'#'} target="_blank" onClick={() => downloadFile(items.supporting_files_url)}>
                      <img src={items.supporting_files_url} alt="" style={{width:200, border:"1px solid #ccc", padding:'5px'}}/>
                    </Link>
                  </Grid>
                ))
