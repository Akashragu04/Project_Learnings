            ...
            <Box sx={{ border: "1px solid #ccc", padding: 5 }}>
                <Formik
                    ...
                    onSubmit={(values, { setSubmitting, resetForm }) => {
                        const postData: any = {
                            it_info: props.setBizCaseSetupData,
                            it_data: values.facility
                        }
                                                            ...
                                                            facilityValue.facility.map((facilityProperty: any, index: any) => (
                                                                <Box className='flexcolumbox' sx={{ marginBottom: 5 }}>
                                                                    ...
                                                                    <Grid item xs={12} md={2} sx={{ marginRight: 2 }}>
                                                                        <FormControl variant="outlined" fullWidth margin='dense'>
                                                                            <TextField name={`facility.${index}.quantity`} value={facilityProperty.quantity}
                                                                    ...
                                                                    <Grid item xs={12} md={2} sx={{ marginRight: 2 }}>
                                                                        <FormControl variant="outlined" fullWidth margin='dense'>
                                                                            <TextField name={`facility.${index}.cost`} label='Cost' variant='outlined' onChange={handleChange}
...
export default ItAddFormQuantity;
