...
import { CommonMainValidationSchema } from './CommonMainValidation';

const CommonMainContentForm = (props:any) => {
  return (
    <Box sx={{ padding: 5 }}>
    <Formik
        validateOnChange
        ...
        validationSchema={CommonMainValidationSchema}
...
export default CommonMainContentForm;