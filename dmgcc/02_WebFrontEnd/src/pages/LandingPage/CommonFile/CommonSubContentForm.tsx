...
import { CommonSubValidationSchema } from './CommonSubValidation';

const CommonSubContentForm = (props:any) => {
  return (
    <Box sx={{ padding: 5 }}>
            <Formik
                validateOnChange
                ...
                validationSchema={CommonSubValidationSchema}
...
export default CommonSubContentForm;