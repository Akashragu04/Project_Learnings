...
const AddFormManuFacturing = (props:any) => {
  ...
  return (
    ...
    title={"Add Manufacturing - Main Content"}
>
    {
        getInitilValues?
        <ManufacturingMainContentForm getInitilValues={getInitilValues} handleClose={props.closeOpenAddForm} onSubmit={props.onSubmit}/>    
        :null
    }
...
export default AddFormManuFacturing;