...
const AddSubContentManufacturing = (props:any) => {
...
props.closeOpenAddContentForm()
    ...
    return (
        ...
        title={"Add Manufacturing - Sub Content"}
    >
       <SubContentFormManufacturing getInitilContentValues={getInitilContentValues} goBack={goBack} showViewContent={false} onSubmit={props.onSubmit}/>
            </AppDialog>
            )
}

export default AddSubContentManufacturing;
