...
const BrochureViewDetails = (props: any) => {
    ...
    React.useEffect(()=>{
        if(props.openBrochureDetails && props.openBrochureDetails.brochureFile){
            setDownloadFiles(props.openBrochureDetails.brochureFile.supporting_file_view_url)
        }
        ...
        <React.Fragment>                     
            ...
            >
                <AppBar sx={{ position: 'relative', background:'#00677f' }}>
                    <Toolbar>
                        <Typography sx={{ flex: 1, textTransform:'Capitalize' }} variant="h3" component="div">
                            Brochure Name: {props.openBrochureDetails ? props.openBrochureDetails.title : '-'}
                        </Typography>
                        <IconButton
                            edge="start"
                            color="inherit"
                ...
                <Box sx={{margin:2}}>
                    <Typography sx={{ ml: 2, flex: 1, mt: 2, textTransform:'Capitalize' }} variant="h2" >
